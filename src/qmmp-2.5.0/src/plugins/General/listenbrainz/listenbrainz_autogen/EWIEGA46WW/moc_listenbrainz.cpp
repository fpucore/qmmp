...
namespace {
struct qt_meta_tag_ZN12ListenBrainzE_t {};
} // unnamed namespace

template <> constexpr inline auto ListenBrainz::qt_create_metaobjectdata<qt_meta_tag_ZN12ListenBrainzE_t>()
{
    ...
    return QtMocHelpers::metaObjectData<ListenBrainz, qt_meta_tag_ZN12ListenBrainzE_t>(QMC::MetaObjectFlag{}, qt_stringData,
            qt_methods, qt_properties, qt_enums);
}
Q_CONSTINIT const QMetaObject ListenBrainz::staticMetaObject = { {
    QMetaObject::SuperData::link<QObject::staticMetaObject>(),
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN12ListenBrainzE_t>.stringdata,
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN12ListenBrainzE_t>.data,
    qt_static_metacall,
    nullptr,
    qt_staticMetaObjectRelocatingContent<qt_meta_tag_ZN12ListenBrainzE_t>.metaTypes,
    nullptr
} };
...
void *ListenBrainz::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_staticMetaObjectStaticContent<qt_meta_tag_ZN12ListenBrainzE_t>.strings))
