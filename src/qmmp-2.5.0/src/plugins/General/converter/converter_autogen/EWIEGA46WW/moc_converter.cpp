...
template <> constexpr inline auto Converter::qt_create_metaobjectdata<qt_meta_tag_ZN9ConverterE_t>()
{
    ...
    QtMocHelpers::UintData qt_methods {
        ...
        // Signal 'finished'
        QtMocHelpers::SignalData<void(Converter *)>(4, 2, QMC::AccessPublic, QMetaType::Void, {{
            { 0x80000000 | 5, 6 },
        }}),
        // Signal 'message'
        QtMocHelpers::SignalData<void(int, QString)>(7, 2, QMC::AccessPublic, QMetaType::Void, {{
            { QMetaType::Int, 8 }, { QMetaType::QString, 7 },
        }}),
        // Slot 'stop'
...
void Converter::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->finished((*reinterpret_cast<std::add_pointer_t<Converter*>>(_a[1]))); break;
        case 2: _t->message((*reinterpret_cast<std::add_pointer_t<int>>(_a[1])),(*reinterpret_cast<std::add_pointer_t<QString>>(_a[2]))); break;
    ...
    if (_c == QMetaObject::RegisterMethodArgumentMetaType) {
        ...
        case 1:
            ...
            default: *reinterpret_cast<QMetaType *>(_a[0]) = QMetaType(); break;
            case 0:
                *reinterpret_cast<QMetaType *>(_a[0]) = QMetaType::fromType< Converter* >(); break;
            }
            break;
        }
    }
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (Converter::*)(int )>(_a, &Converter::progress, 0))
            return;
        if (QtMocHelpers::indexOfMethod<void (Converter::*)(Converter * )>(_a, &Converter::finished, 1))
            return;
        if (QtMocHelpers::indexOfMethod<void (Converter::*)(int , QString )>(_a, &Converter::message, 2))
            return;
    }
}
...
// SIGNAL 0
void Converter::progress(int _t1)
{
    QMetaObject::activate<void>(this, &staticMetaObject, 0, nullptr, _t1);
}

// SIGNAL 1
void Converter::finished(Converter * _t1)
{
    QMetaObject::activate<void>(this, &staticMetaObject, 1, nullptr, _t1);
}

// SIGNAL 2
void Converter::message(int _t1, QString _t2)
{
