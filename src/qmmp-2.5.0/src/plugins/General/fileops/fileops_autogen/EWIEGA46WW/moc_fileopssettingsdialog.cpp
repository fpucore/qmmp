...
namespace {
struct qt_meta_tag_ZN21FileOpsSettingsDialogE_t {};
} // unnamed namespace

template <> constexpr inline auto FileOpsSettingsDialog::qt_create_metaobjectdata<qt_meta_tag_ZN21FileOpsSettingsDialogE_t>()
{
    ...
    return QtMocHelpers::metaObjectData<FileOpsSettingsDialog, qt_meta_tag_ZN21FileOpsSettingsDialogE_t>(QMC::MetaObjectFlag{}, qt_stringData,
            qt_methods, qt_properties, qt_enums);
}
Q_CONSTINIT const QMetaObject FileOpsSettingsDialog::staticMetaObject = { {
    QMetaObject::SuperData::link<QDialog::staticMetaObject>(),
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN21FileOpsSettingsDialogE_t>.stringdata,
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN21FileOpsSettingsDialogE_t>.data,
    qt_static_metacall,
    nullptr,
    qt_staticMetaObjectRelocatingContent<qt_meta_tag_ZN21FileOpsSettingsDialogE_t>.metaTypes,
    nullptr
} };
...
void *FileOpsSettingsDialog::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_staticMetaObjectStaticContent<qt_meta_tag_ZN21FileOpsSettingsDialogE_t>.strings))
