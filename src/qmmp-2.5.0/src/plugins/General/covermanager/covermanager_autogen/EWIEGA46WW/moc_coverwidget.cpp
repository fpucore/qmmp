...
namespace {
struct qt_meta_tag_ZN11CoverWidgetE_t {};
} // unnamed namespace

template <> constexpr inline auto CoverWidget::qt_create_metaobjectdata<qt_meta_tag_ZN11CoverWidgetE_t>()
{
    ...
    return QtMocHelpers::metaObjectData<CoverWidget, qt_meta_tag_ZN11CoverWidgetE_t>(QMC::MetaObjectFlag{}, qt_stringData,
            qt_methods, qt_properties, qt_enums);
}
Q_CONSTINIT const QMetaObject CoverWidget::staticMetaObject = { {
    QMetaObject::SuperData::link<QWidget::staticMetaObject>(),
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN11CoverWidgetE_t>.stringdata,
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN11CoverWidgetE_t>.data,
    qt_static_metacall,
    nullptr,
    qt_staticMetaObjectRelocatingContent<qt_meta_tag_ZN11CoverWidgetE_t>.metaTypes,
    nullptr
} };
...
void *CoverWidget::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_staticMetaObjectStaticContent<qt_meta_tag_ZN11CoverWidgetE_t>.strings))
