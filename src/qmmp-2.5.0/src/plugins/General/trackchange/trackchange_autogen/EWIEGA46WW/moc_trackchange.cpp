...
namespace {
struct qt_meta_tag_ZN11TrackChangeE_t {};
} // unnamed namespace

template <> constexpr inline auto TrackChange::qt_create_metaobjectdata<qt_meta_tag_ZN11TrackChangeE_t>()
{
    ...
    return QtMocHelpers::metaObjectData<TrackChange, qt_meta_tag_ZN11TrackChangeE_t>(QMC::MetaObjectFlag{}, qt_stringData,
            qt_methods, qt_properties, qt_enums);
}
Q_CONSTINIT const QMetaObject TrackChange::staticMetaObject = { {
    QMetaObject::SuperData::link<QObject::staticMetaObject>(),
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN11TrackChangeE_t>.stringdata,
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN11TrackChangeE_t>.data,
    qt_static_metacall,
    nullptr,
    qt_staticMetaObjectRelocatingContent<qt_meta_tag_ZN11TrackChangeE_t>.metaTypes,
    nullptr
} };
...
void *TrackChange::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_staticMetaObjectStaticContent<qt_meta_tag_ZN11TrackChangeE_t>.strings))
