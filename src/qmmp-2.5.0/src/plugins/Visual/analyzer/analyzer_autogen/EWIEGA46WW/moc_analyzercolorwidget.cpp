...
namespace {
struct qt_meta_tag_ZN19AnalyzerColorWidgetE_t {};
} // unnamed namespace

template <> constexpr inline auto AnalyzerColorWidget::qt_create_metaobjectdata<qt_meta_tag_ZN19AnalyzerColorWidgetE_t>()
{
    ...
    return QtMocHelpers::metaObjectData<AnalyzerColorWidget, qt_meta_tag_ZN19AnalyzerColorWidgetE_t>(QMC::MetaObjectFlag{}, qt_stringData,
            qt_methods, qt_properties, qt_enums);
}
Q_CONSTINIT const QMetaObject AnalyzerColorWidget::staticMetaObject = { {
    QMetaObject::SuperData::link<QFrame::staticMetaObject>(),
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN19AnalyzerColorWidgetE_t>.stringdata,
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN19AnalyzerColorWidgetE_t>.data,
    qt_static_metacall,
    nullptr,
    qt_staticMetaObjectRelocatingContent<qt_meta_tag_ZN19AnalyzerColorWidgetE_t>.metaTypes,
    nullptr
} };
...
void *AnalyzerColorWidget::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_staticMetaObjectStaticContent<qt_meta_tag_ZN19AnalyzerColorWidgetE_t>.strings))
