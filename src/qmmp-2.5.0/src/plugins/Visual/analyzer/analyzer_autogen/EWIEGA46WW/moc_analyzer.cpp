...
namespace {
struct qt_meta_tag_ZN8AnalyzerE_t {};
} // unnamed namespace

template <> constexpr inline auto Analyzer::qt_create_metaobjectdata<qt_meta_tag_ZN8AnalyzerE_t>()
{
    ...
    return QtMocHelpers::metaObjectData<Analyzer, qt_meta_tag_ZN8AnalyzerE_t>(QMC::MetaObjectFlag{}, qt_stringData,
            qt_methods, qt_properties, qt_enums);
}
Q_CONSTINIT const QMetaObject Analyzer::staticMetaObject = { {
    QMetaObject::SuperData::link<Visual::staticMetaObject>(),
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN8AnalyzerE_t>.stringdata,
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN8AnalyzerE_t>.data,
    qt_static_metacall,
    nullptr,
    qt_staticMetaObjectRelocatingContent<qt_meta_tag_ZN8AnalyzerE_t>.metaTypes,
    nullptr
} };
...
void *Analyzer::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_staticMetaObjectStaticContent<qt_meta_tag_ZN8AnalyzerE_t>.strings))
