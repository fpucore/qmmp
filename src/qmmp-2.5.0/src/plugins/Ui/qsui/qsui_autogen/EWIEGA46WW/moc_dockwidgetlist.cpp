...
namespace {
struct qt_meta_tag_ZN14DockWidgetListE_t {};
} // unnamed namespace

template <> constexpr inline auto DockWidgetList::qt_create_metaobjectdata<qt_meta_tag_ZN14DockWidgetListE_t>()
{
    ...
    QtMocHelpers::UintData qt_methods {
        ...
        // Slot 'onWidgetRemoved'
        QtMocHelpers::SlotData<void(const QString &)>(8, 2, QMC::AccessPrivate, QMetaType::Void, {{
            { QMetaType::QString, 7 },
        }}),
        // Slot 'onWidgetUpdated'
    ...
    return QtMocHelpers::metaObjectData<DockWidgetList, qt_meta_tag_ZN14DockWidgetListE_t>(QMC::MetaObjectFlag{}, qt_stringData,
            qt_methods, qt_properties, qt_enums);
}
Q_CONSTINIT const QMetaObject DockWidgetList::staticMetaObject = { {
    QMetaObject::SuperData::link<QObject::staticMetaObject>(),
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN14DockWidgetListE_t>.stringdata,
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN14DockWidgetListE_t>.data,
    qt_static_metacall,
    nullptr,
    qt_staticMetaObjectRelocatingContent<qt_meta_tag_ZN14DockWidgetListE_t>.metaTypes,
    nullptr
} };
...
void *DockWidgetList::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_staticMetaObjectStaticContent<qt_meta_tag_ZN14DockWidgetListE_t>.strings))
