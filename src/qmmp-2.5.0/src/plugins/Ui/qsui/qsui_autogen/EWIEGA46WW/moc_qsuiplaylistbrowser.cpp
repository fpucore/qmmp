...
namespace {
struct qt_meta_tag_ZN19QSUiPlayListBrowserE_t {};
} // unnamed namespace

template <> constexpr inline auto QSUiPlayListBrowser::qt_create_metaobjectdata<qt_meta_tag_ZN19QSUiPlayListBrowserE_t>()
{
    ...
    QtMocHelpers::UintData qt_methods {
        ...
        QtMocHelpers::SlotData<void(QModelIndex, QModelIndex)>(8, 2, QMC::AccessPrivate, QMetaType::Void, {{
    ...
    return QtMocHelpers::metaObjectData<QSUiPlayListBrowser, qt_meta_tag_ZN19QSUiPlayListBrowserE_t>(QMC::MetaObjectFlag{}, qt_stringData,
            qt_methods, qt_properties, qt_enums);
}
Q_CONSTINIT const QMetaObject QSUiPlayListBrowser::staticMetaObject = { {
    QMetaObject::SuperData::link<QWidget::staticMetaObject>(),
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN19QSUiPlayListBrowserE_t>.stringdata,
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN19QSUiPlayListBrowserE_t>.data,
    qt_static_metacall,
    nullptr,
    qt_staticMetaObjectRelocatingContent<qt_meta_tag_ZN19QSUiPlayListBrowserE_t>.metaTypes,
    nullptr
} };
...
void *QSUiPlayListBrowser::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_staticMetaObjectStaticContent<qt_meta_tag_ZN19QSUiPlayListBrowserE_t>.strings))
