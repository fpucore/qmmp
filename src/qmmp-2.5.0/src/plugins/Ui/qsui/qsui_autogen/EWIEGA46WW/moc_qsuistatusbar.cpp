...
namespace {
struct qt_meta_tag_ZN13QSUiStatusBarE_t {};
} // unnamed namespace

template <> constexpr inline auto QSUiStatusBar::qt_create_metaobjectdata<qt_meta_tag_ZN13QSUiStatusBarE_t>()
{
    ...
    QtMocHelpers::UintData qt_methods {
        ...
        // Slot 'onBufferingProgress'
        QtMocHelpers::SlotData<void(int)>(5, 2, QMC::AccessPrivate, QMetaType::Void, {{
            { QMetaType::Int, 6 },
        }}),
        // Slot 'onAudioParametersChanged'
        QtMocHelpers::SlotData<void(const AudioParameters &)>(7, 2, QMC::AccessPrivate, QMetaType::Void, {{
            { 0x80000000 | 8, 9 },
        }}),
        // Slot 'onBitrateChanged'
    ...
    return QtMocHelpers::metaObjectData<QSUiStatusBar, qt_meta_tag_ZN13QSUiStatusBarE_t>(QMC::MetaObjectFlag{}, qt_stringData,
            qt_methods, qt_properties, qt_enums);
}
Q_CONSTINIT const QMetaObject QSUiStatusBar::staticMetaObject = { {
    QMetaObject::SuperData::link<QWidget::staticMetaObject>(),
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN13QSUiStatusBarE_t>.stringdata,
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN13QSUiStatusBarE_t>.data,
    qt_static_metacall,
    nullptr,
    qt_staticMetaObjectRelocatingContent<qt_meta_tag_ZN13QSUiStatusBarE_t>.metaTypes,
    nullptr
} };
...
void *QSUiStatusBar::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_staticMetaObjectStaticContent<qt_meta_tag_ZN13QSUiStatusBarE_t>.strings))
