...
namespace {
struct qt_meta_tag_ZN19QSUiStatusBarEditorE_t {};
} // unnamed namespace

template <> constexpr inline auto QSUiStatusBarEditor::qt_create_metaobjectdata<qt_meta_tag_ZN19QSUiStatusBarEditorE_t>()
{
    ...
    return QtMocHelpers::metaObjectData<QSUiStatusBarEditor, qt_meta_tag_ZN19QSUiStatusBarEditorE_t>(QMC::MetaObjectFlag{}, qt_stringData,
            qt_methods, qt_properties, qt_enums);
}
Q_CONSTINIT const QMetaObject QSUiStatusBarEditor::staticMetaObject = { {
    QMetaObject::SuperData::link<QDialog::staticMetaObject>(),
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN19QSUiStatusBarEditorE_t>.stringdata,
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN19QSUiStatusBarEditorE_t>.data,
    qt_static_metacall,
    nullptr,
    qt_staticMetaObjectRelocatingContent<qt_meta_tag_ZN19QSUiStatusBarEditorE_t>.metaTypes,
    nullptr
} };
...
void *QSUiStatusBarEditor::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_staticMetaObjectStaticContent<qt_meta_tag_ZN19QSUiStatusBarEditorE_t>.strings))
