...
namespace {
struct qt_meta_tag_ZN13QSUiEqualizerE_t {};
} // unnamed namespace

template <> constexpr inline auto QSUiEqualizer::qt_create_metaobjectdata<qt_meta_tag_ZN13QSUiEqualizerE_t>()
{
    ...
    return QtMocHelpers::metaObjectData<QSUiEqualizer, qt_meta_tag_ZN13QSUiEqualizerE_t>(QMC::MetaObjectFlag{}, qt_stringData,
            qt_methods, qt_properties, qt_enums);
}
Q_CONSTINIT const QMetaObject QSUiEqualizer::staticMetaObject = { {
    QMetaObject::SuperData::link<QDialog::staticMetaObject>(),
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN13QSUiEqualizerE_t>.stringdata,
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN13QSUiEqualizerE_t>.data,
    qt_static_metacall,
    nullptr,
    qt_staticMetaObjectRelocatingContent<qt_meta_tag_ZN13QSUiEqualizerE_t>.metaTypes,
    nullptr
} };
...
void *QSUiEqualizer::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_staticMetaObjectStaticContent<qt_meta_tag_ZN13QSUiEqualizerE_t>.strings))
