...
namespace {
struct qt_meta_tag_ZN13SymbolDisplayE_t {};
} // unnamed namespace

template <> constexpr inline auto SymbolDisplay::qt_create_metaobjectdata<qt_meta_tag_ZN13SymbolDisplayE_t>()
{
    ...
    return QtMocHelpers::metaObjectData<SymbolDisplay, qt_meta_tag_ZN13SymbolDisplayE_t>(QMC::MetaObjectFlag{}, qt_stringData,
...
Q_CONSTINIT const QMetaObject SymbolDisplay::staticMetaObject = { {
    ...
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN13SymbolDisplayE_t>.stringdata,
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN13SymbolDisplayE_t>.data,
    qt_static_metacall,
    nullptr,
    qt_staticMetaObjectRelocatingContent<qt_meta_tag_ZN13SymbolDisplayE_t>.metaTypes,
    nullptr
} };
...
void *SymbolDisplay::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_staticMetaObjectStaticContent<qt_meta_tag_ZN13SymbolDisplayE_t>.strings))
