...
namespace {
struct qt_meta_tag_ZN19EffectStereoFactoryE_t {};
} // unnamed namespace

template <> constexpr inline auto EffectStereoFactory::qt_create_metaobjectdata<qt_meta_tag_ZN19EffectStereoFactoryE_t>()
{
    ...
    return QtMocHelpers::metaObjectData<EffectStereoFactory, qt_meta_tag_ZN19EffectStereoFactoryE_t>(QMC::MetaObjectFlag{}, qt_stringData,
            qt_methods, qt_properties, qt_enums);
}
Q_CONSTINIT const QMetaObject EffectStereoFactory::staticMetaObject = { {
    QMetaObject::SuperData::link<QObject::staticMetaObject>(),
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN19EffectStereoFactoryE_t>.stringdata,
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN19EffectStereoFactoryE_t>.data,
    qt_static_metacall,
    nullptr,
    qt_staticMetaObjectRelocatingContent<qt_meta_tag_ZN19EffectStereoFactoryE_t>.metaTypes,
    nullptr
} };

void EffectStereoFactory::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    auto *_t = static_cast<EffectStereoFactory *>(_o);
    (void)_t;
    (void)_c;
    (void)_id;
    (void)_a;
...
void *EffectStereoFactory::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_staticMetaObjectStaticContent<qt_meta_tag_ZN19EffectStereoFactoryE_t>.strings))
