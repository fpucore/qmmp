...
namespace {
struct qt_meta_tag_ZN22EffectCrossfadeFactoryE_t {};
} // unnamed namespace

template <> constexpr inline auto EffectCrossfadeFactory::qt_create_metaobjectdata<qt_meta_tag_ZN22EffectCrossfadeFactoryE_t>()
{
    ...
    return QtMocHelpers::metaObjectData<EffectCrossfadeFactory, qt_meta_tag_ZN22EffectCrossfadeFactoryE_t>(QMC::MetaObjectFlag{}, qt_stringData,
            qt_methods, qt_properties, qt_enums);
}
Q_CONSTINIT const QMetaObject EffectCrossfadeFactory::staticMetaObject = { {
    QMetaObject::SuperData::link<QObject::staticMetaObject>(),
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN22EffectCrossfadeFactoryE_t>.stringdata,
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN22EffectCrossfadeFactoryE_t>.data,
    qt_static_metacall,
    nullptr,
    qt_staticMetaObjectRelocatingContent<qt_meta_tag_ZN22EffectCrossfadeFactoryE_t>.metaTypes,
    nullptr
} };

void EffectCrossfadeFactory::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    auto *_t = static_cast<EffectCrossfadeFactory *>(_o);
    (void)_t;
    (void)_c;
    (void)_id;
    (void)_a;
...
void *EffectCrossfadeFactory::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_staticMetaObjectStaticContent<qt_meta_tag_ZN22EffectCrossfadeFactoryE_t>.strings))
