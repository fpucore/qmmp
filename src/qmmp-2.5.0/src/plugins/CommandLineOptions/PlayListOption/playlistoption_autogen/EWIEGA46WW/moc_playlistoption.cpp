...
namespace {
struct qt_meta_tag_ZN14PlayListOptionE_t {};
} // unnamed namespace

template <> constexpr inline auto PlayListOption::qt_create_metaobjectdata<qt_meta_tag_ZN14PlayListOptionE_t>()
{
    ...
    return QtMocHelpers::metaObjectData<PlayListOption, qt_meta_tag_ZN14PlayListOptionE_t>(QMC::MetaObjectFlag{}, qt_stringData,
            qt_methods, qt_properties, qt_enums);
}
Q_CONSTINIT const QMetaObject PlayListOption::staticMetaObject = { {
    QMetaObject::SuperData::link<QObject::staticMetaObject>(),
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN14PlayListOptionE_t>.stringdata,
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN14PlayListOptionE_t>.data,
    qt_static_metacall,
    nullptr,
    qt_staticMetaObjectRelocatingContent<qt_meta_tag_ZN14PlayListOptionE_t>.metaTypes,
    nullptr
} };

void PlayListOption::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    auto *_t = static_cast<PlayListOption *>(_o);
    (void)_t;
    (void)_c;
    (void)_id;
    (void)_a;
...
void *PlayListOption::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_staticMetaObjectStaticContent<qt_meta_tag_ZN14PlayListOptionE_t>.strings))
