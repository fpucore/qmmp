...
namespace {
struct qt_meta_tag_ZN29IncDecVolumeCommandLineOptionE_t {};
} // unnamed namespace

template <> constexpr inline auto IncDecVolumeCommandLineOption::qt_create_metaobjectdata<qt_meta_tag_ZN29IncDecVolumeCommandLineOptionE_t>()
{
    ...
    return QtMocHelpers::metaObjectData<IncDecVolumeCommandLineOption, qt_meta_tag_ZN29IncDecVolumeCommandLineOptionE_t>(QMC::MetaObjectFlag{}, qt_stringData,
            qt_methods, qt_properties, qt_enums);
}
Q_CONSTINIT const QMetaObject IncDecVolumeCommandLineOption::staticMetaObject = { {
    QMetaObject::SuperData::link<QObject::staticMetaObject>(),
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN29IncDecVolumeCommandLineOptionE_t>.stringdata,
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN29IncDecVolumeCommandLineOptionE_t>.data,
    qt_static_metacall,
    nullptr,
    qt_staticMetaObjectRelocatingContent<qt_meta_tag_ZN29IncDecVolumeCommandLineOptionE_t>.metaTypes,
    nullptr
} };

void IncDecVolumeCommandLineOption::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    auto *_t = static_cast<IncDecVolumeCommandLineOption *>(_o);
    (void)_t;
    (void)_c;
    (void)_id;
    (void)_a;
...
void *IncDecVolumeCommandLineOption::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_staticMetaObjectStaticContent<qt_meta_tag_ZN29IncDecVolumeCommandLineOptionE_t>.strings))
