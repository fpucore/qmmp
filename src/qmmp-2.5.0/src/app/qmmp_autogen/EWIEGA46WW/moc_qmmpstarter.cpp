...
namespace {
struct qt_meta_tag_ZN11QMMPStarterE_t {};
} // unnamed namespace

template <> constexpr inline auto QMMPStarter::qt_create_metaobjectdata<qt_meta_tag_ZN11QMMPStarterE_t>()
{
    ...
    QtMocHelpers::UintData qt_methods {
        ...
        // Slot 'commitData'
        QtMocHelpers::SlotData<void(QSessionManager &)>(5, 2, QMC::AccessPrivate, QMetaType::Void, {{
            { 0x80000000 | 6, 7 },
        }}),
        // Slot 'handleSigTerm'
    ...
    return QtMocHelpers::metaObjectData<QMMPStarter, qt_meta_tag_ZN11QMMPStarterE_t>(QMC::MetaObjectFlag{}, qt_stringData,
            qt_methods, qt_properties, qt_enums);
}
Q_CONSTINIT const QMetaObject QMMPStarter::staticMetaObject = { {
    QMetaObject::SuperData::link<QObject::staticMetaObject>(),
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN11QMMPStarterE_t>.stringdata,
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN11QMMPStarterE_t>.data,
    qt_static_metacall,
    nullptr,
    qt_staticMetaObjectRelocatingContent<qt_meta_tag_ZN11QMMPStarterE_t>.metaTypes,
    nullptr
} };
...
void *QMMPStarter::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_staticMetaObjectStaticContent<qt_meta_tag_ZN11QMMPStarterE_t>.strings))
