...
#define __SEG_FS 1
#define QMMP_PLUGIN_DIR "/usr/lib/qmmp-2.5"
...
#define __linux__ 1
#define QT_DISABLE_DEPRECATED_BEFORE 0x060200
...
#define QMMP_INSTALL_PREFIX "/usr"
