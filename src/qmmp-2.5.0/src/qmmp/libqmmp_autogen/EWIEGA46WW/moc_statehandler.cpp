...
namespace {
struct qt_meta_tag_ZN12StateHandlerE_t {};
} // unnamed namespace

template <> constexpr inline auto StateHandler::qt_create_metaobjectdata<qt_meta_tag_ZN12StateHandlerE_t>()
{
    ...
    QtMocHelpers::UintData qt_methods {
        ...
        QtMocHelpers::SignalData<void(const AudioParameters &)>(6, 2, QMC::AccessPublic, QMetaType::Void, {{
            { 0x80000000 | 7, 8 },
        }}),
    ...
    return QtMocHelpers::metaObjectData<StateHandler, qt_meta_tag_ZN12StateHandlerE_t>(QMC::MetaObjectFlag{}, qt_stringData,
            qt_methods, qt_properties, qt_enums);
}
Q_CONSTINIT const QMetaObject StateHandler::staticMetaObject = { {
    QMetaObject::SuperData::link<QObject::staticMetaObject>(),
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN12StateHandlerE_t>.stringdata,
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN12StateHandlerE_t>.data,
    qt_static_metacall,
    nullptr,
    qt_staticMetaObjectRelocatingContent<qt_meta_tag_ZN12StateHandlerE_t>.metaTypes,
    nullptr
} };
...
void StateHandler::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (StateHandler::*)(qint64 )>(_a, &StateHandler::elapsedChanged, 0))
            return;
        if (QtMocHelpers::indexOfMethod<void (StateHandler::*)(int )>(_a, &StateHandler::bitrateChanged, 1))
            return;
        if (QtMocHelpers::indexOfMethod<void (StateHandler::*)(const AudioParameters & )>(_a, &StateHandler::audioParametersChanged, 2))
            return;
        if (QtMocHelpers::indexOfMethod<void (StateHandler::*)(int )>(_a, &StateHandler::bufferingProgress, 3))
            return;
    }
}
...
void *StateHandler::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_staticMetaObjectStaticContent<qt_meta_tag_ZN12StateHandlerE_t>.strings))
