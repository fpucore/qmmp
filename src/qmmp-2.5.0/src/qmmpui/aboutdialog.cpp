...
QString AboutDialog::loadAbout()
{
    ...
    text.append(tr("System: %1").arg(QSysInfo::prettyProductName()) + u"</p>"_s);
    text.append(u"<p>"_s);
    text.append(tr("Compiled by Chris McGimpsey-Jones.") + u"</p>"_s);
    text.append(u"<p>"_s);
    text.append(tr("Copyright (c) %1 Harmonious Platform Systems. All rights reserved.").arg(2026) + u"<br>"_s);
    text.append(u"<a href=\"https://www.freedompublishersunion.net/h-linux.html\">https://www.freedompublishersunion.net/h-linux.html</a><br>"_s);
    text.append(u"</p>"_s);
    text.append(u"<p>"_s);
    text.append(tr("Copyright (c) %1-2026 Qmmp Development Team").arg(2006) + u"</p>"_s);
