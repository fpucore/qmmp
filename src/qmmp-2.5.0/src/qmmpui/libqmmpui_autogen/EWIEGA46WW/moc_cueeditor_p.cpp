...
namespace {
struct qt_meta_tag_ZN9CueEditorE_t {};
} // unnamed namespace

template <> constexpr inline auto CueEditor::qt_create_metaobjectdata<qt_meta_tag_ZN9CueEditorE_t>()
{
    ...
    return QtMocHelpers::metaObjectData<CueEditor, qt_meta_tag_ZN9CueEditorE_t>(QMC::MetaObjectFlag{}, qt_stringData,
            qt_methods, qt_properties, qt_enums);
}
Q_CONSTINIT const QMetaObject CueEditor::staticMetaObject = { {
    QMetaObject::SuperData::link<QWidget::staticMetaObject>(),
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN9CueEditorE_t>.stringdata,
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN9CueEditorE_t>.data,
    qt_static_metacall,
    nullptr,
    qt_staticMetaObjectRelocatingContent<qt_meta_tag_ZN9CueEditorE_t>.metaTypes,
    nullptr
} };
...
void *CueEditor::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_staticMetaObjectStaticContent<qt_meta_tag_ZN9CueEditorE_t>.strings))
