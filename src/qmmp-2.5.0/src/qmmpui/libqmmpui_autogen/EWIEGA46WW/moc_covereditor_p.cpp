...
namespace {
struct qt_meta_tag_ZN11CoverEditorE_t {};
} // unnamed namespace

template <> constexpr inline auto CoverEditor::qt_create_metaobjectdata<qt_meta_tag_ZN11CoverEditorE_t>()
{
    ...
    QtMocHelpers::UintData qt_methods {
        // Slot 'on_sourceComboBox_activated'
    ...
    return QtMocHelpers::metaObjectData<CoverEditor, qt_meta_tag_ZN11CoverEditorE_t>(QMC::MetaObjectFlag{}, qt_stringData,
            qt_methods, qt_properties, qt_enums);
}
Q_CONSTINIT const QMetaObject CoverEditor::staticMetaObject = { {
    QMetaObject::SuperData::link<QWidget::staticMetaObject>(),
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN11CoverEditorE_t>.stringdata,
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN11CoverEditorE_t>.data,
    qt_static_metacall,
    nullptr,
    qt_staticMetaObjectRelocatingContent<qt_meta_tag_ZN11CoverEditorE_t>.metaTypes,
    nullptr
} };
...
void *CoverEditor::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_staticMetaObjectStaticContent<qt_meta_tag_ZN11CoverEditorE_t>.strings))
